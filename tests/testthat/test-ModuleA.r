# Test the input of the ModuleA function
...
context("ModuleA - Success runs")

test_that("Success run ModuleA with Normal case", {
  ...
  ModuleAReport(results, tempfile(fileext = ".docx"))
})

test_that("Success run ModuleA with Binary case", {

  # Success run
  results = ModuleA(binaryCase)
  expect_type(results$sim_results, "double")
  expect_type(results$sim_summary, "list")
...
test_that("Success run ModuleA with Time-to-event case", {

  # Success run
  results = ModuleA(timeToEventCase)
  expect_type(results$sim_results, "double")
  expect_type(results$sim_summary, "list")
  expect_length(results$sim_results, 1900)
...
context("ModuleA - Error checks")

test_that("Input parameters errors check ModuleA", {
  ...
  expect_error(
    ...
    info = "Checking for wrong information fractions (incorrect value size)"
  )
...
test_that("Input parameters errors check ModuleAReport", {
