# Test the input of the ModuleD function
...
context("ModuleD - Success runs")

test_that("Success run ModuleD with Normal case", {

  # Success run 
  results = ModuleD(normalCase)
  expect_is(results, "ModuleDResults")
  ...
  ModuleDReport(results, tempfile(fileext = ".docx"))
})

test_that("Success run ModuleD with Binary case", {

  # Success run 
  results = ModuleD(binaryCase)
...
test_that("Success run ModuleD with Time-to-event case", {

  # Success run 
  results = ModuleD(timeToEventCase)
...
test_that("Success run ModuleD with default parameters", {
...
context("ModuleD - Error checks")

test_that("Input parameters errors check ModuleD", {
  # Errors check
  expect_error(
    ModuleD(
      c("Not a list")
...
test_that("Input parameters errors check ModuleDReport", {
